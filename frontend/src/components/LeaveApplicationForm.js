...
import backgroundImage from '../components/pic.jpg';
...
const handleSubmit = async (e) => {
    ...
    return (
        <>
             <section className="vh-100 gradient-custom" style={{backgroundImage:`url(${backgroundImage})` , backgroundPosition:"center" , backgroundSize:'cover' }}>
                        ...
                        <div className="card shadow-lg p-4 p-md-5 rounded-3" style={{background: 'linear-gradient(to right, #6f42c1, #20c997)'}}>
                            ...
                            <form onSubmit={handleSubmit} method="POST">
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="date" className="form-control form-control-lg" name="start_date" onChange={handleChange} value={data.start_date} />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="exampleInputDate1" className="form-label fw-bold">End Date</label>
                                    <input type="date" className="form-control form-control-lg" name="end_date" onChange={handleChange} value={data.end_date} />
                                </div>
